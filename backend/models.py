...
class Products(database.Base):
    ...
    name = sql.Column(sql.String,default='Product')
    brand = sql.Column(sql.String,default='Unknown Brand')
    description = sql.Column(sql.String,default='No Description')
    price = sql.Column(sql.Float,default=50)
